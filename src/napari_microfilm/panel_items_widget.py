...
class PanelItemModel(QtListModel):
    """Model for QtListView of PanelElements"""
...
class PanelItemListWidget(QtListView):
    """QtListView comes from napari and works with SelectableEventedList."""

    def __init__(self, root, parent=None):
        super().__init__(root, parent=parent)
        self.setModel(PanelItemModel(root))
        self.setStyleSheet("PanelElementsListWidget::item { padding: 0px; }")